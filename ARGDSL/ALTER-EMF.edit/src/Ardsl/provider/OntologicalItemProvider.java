...
/**
 * This is the item provider adapter for a {@link Ardsl.Ontological} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OntologicalItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArdslPackage.Literals.ONTOLOGICAL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArdslPackage.Literals.ONTOLOGICAL__CLASSES);
			childrenFeatures.add(ArdslPackage.Literals.ONTOLOGICAL__GRAPHIC);
			childrenFeatures.add(ArdslPackage.Literals.ONTOLOGICAL__PHYSIC);
			childrenFeatures.add(ArdslPackage.Literals.ONTOLOGICAL__GAME);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArdslPackage.Literals.ONTOLOGICAL__CLASSES,
				 ArdslFactory.eINSTANCE.createClass()));

		newChildDescriptors.add
			(createChildParameter
				(ArdslPackage.Literals.ONTOLOGICAL__GRAPHIC,
				 ArdslFactory.eINSTANCE.createGraphic()));

		newChildDescriptors.add
			(createChildParameter
				(ArdslPackage.Literals.ONTOLOGICAL__PHYSIC,
				 ArdslFactory.eINSTANCE.createPhysic()));

		newChildDescriptors.add
			(createChildParameter
				(ArdslPackage.Literals.ONTOLOGICAL__GAME,
				 ArdslFactory.eINSTANCE.createGame()));
	}
