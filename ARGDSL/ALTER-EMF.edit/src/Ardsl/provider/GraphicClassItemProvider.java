...
/**
 * This is the item provider adapter for a {@link Ardsl.GraphicClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphicClassItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArdslPackage.Literals.GRAPHIC_CLASS__ONTO_CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArdslPackage.Literals.GRAPHIC_CLASS__CONSTRAINTS);
			childrenFeatures.add(ArdslPackage.Literals.GRAPHIC_CLASS__CONNECTIONS);
			childrenFeatures.add(ArdslPackage.Literals.GRAPHIC_CLASS__VERSIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArdslPackage.Literals.GRAPHIC_CLASS__CONSTRAINTS,
				 ArdslFactory.eINSTANCE.createConstraints()));

		newChildDescriptors.add
			(createChildParameter
				(ArdslPackage.Literals.GRAPHIC_CLASS__CONNECTIONS,
				 ArdslFactory.eINSTANCE.createConnection()));

		newChildDescriptors.add
			(createChildParameter
				(ArdslPackage.Literals.GRAPHIC_CLASS__VERSIONS,
				 ArdslFactory.eINSTANCE.createVersions()));
	}
