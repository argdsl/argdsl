...
/**
 * This is the item provider adapter for a {@link Ardsl.AttributeValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeValueItemProvider extends ValueItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArdslPackage.Literals.ATTRIBUTE_VALUE__CLASS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArdslPackage.Literals.ATTRIBUTE_VALUE__ATTRIBUTE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AttributeValue.class)) {
			case ArdslPackage.ATTRIBUTE_VALUE__CLASS:
			case ArdslPackage.ATTRIBUTE_VALUE__ATTRIBUTE:
